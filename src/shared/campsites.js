//CAMPSITES is an Array of Objects. This is a common way to store data and it is useful to give each one a unique id.
//export keyword means that this array can be exported to another file.
